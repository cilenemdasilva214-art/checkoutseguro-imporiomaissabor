  ...
  try {
    ...
    if (event.httpMethod === 'GET') {
      ...
      configs.forEach(c => {
        ...
        if (c.key === 'revopay_public_key') result.revopay_public_key = c.value;
    ...
    if (event.httpMethod === 'POST') {
      ...
      if (revopay_public_key !== undefined) payloads.push({ key: 'revopay_public_key', value: (revopay_public_key || '').trim() });
