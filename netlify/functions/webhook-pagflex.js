// Netlify Serverless Function: webhook-pagflex
// Caminho: netlify/functions/webhook-pagflex.js
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log('⚡ Webhook da PagFlexBR recebido:', JSON.stringify(data));
        ...
        data: [
          {
            ...
            event_id: eventId,
            event_source_url: dbRecord.origin || 'https://comprasegura-imporiomaissabor.netlify.app',
